...
// Obtains differential values for f(x,y) = x^2 + y^2, x = 2.0, y = 3.0
...
fn printMain_0()
{
    var _S14 : f32 = sumOfSquares_0(2.0f, 3.0f); 
    g_printedBuffer_0[g_printBufferIndex_0].type_0 = u32(1);
    g_printedBuffer_0[g_printBufferIndex_0].low_0 = u32(i32(-586043194));
    ...
    var _S19 : DiffPair_float_0 = DiffPair_float_0( 2.0f, 1.0f );
    var _S20 : DiffPair_float_0 = DiffPair_float_0( 3.0f, 0.0f );
    var _S21 : DiffPair_float_0 = s_fwd_sumOfSquares_0(_S19, _S20);
    g_printedBuffer_0[g_printBufferIndex_0].type_0 = u32(1);
    g_printedBuffer_0[g_printBufferIndex_0].low_0 = u32(i32(332394896));
    ...
    var _S24 : DiffPair_float_0 = DiffPair_float_0( 3.0f, 1.0f );
    var _S25 : DiffPair_float_0 = s_fwd_sumOfSquares_0(_S19, _S24);
    g_printedBuffer_0[g_printBufferIndex_0].type_0 = u32(1);
    g_printedBuffer_0[g_printBufferIndex_0].low_0 = u32(i32(23282176));
    ...
    g_printedBuffer_0[g_printBufferIndex_0].type_0 = u32(1);
    g_printedBuffer_0[g_printBufferIndex_0].low_0 = u32(i32(-305676711));
    ...
    g_printedBuffer_0[g_printBufferIndex_0].type_0 = u32(1);
    g_printedBuffer_0[g_printBufferIndex_0].low_0 = u32(i32(963570072));
